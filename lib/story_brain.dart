...
void reStart(){
 ...
 void nextStory({int userChoise}){
      if(userChoise ==1 && _storyNumber == 0){
        _storyNumber = 2;
      }else if(userChoise == 2 && _storyNumber == 0){
        _storyNumber = 1;
      }else if(userChoise == 1 && _storyNumber == 2){
        _storyNumber = 5;
      }else if(userChoise == 2 && _storyNumber == 2){
        _storyNumber = 4;
      }else if(userChoise == 1 && _storyNumber == 1){
        _storyNumber = 2;
      }else if(userChoise == 2 && _storyNumber == 1){
        _storyNumber = 3;
